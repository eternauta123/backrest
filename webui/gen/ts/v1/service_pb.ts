...
export const file_v1_service: GenFile = /*@__PURE__*/
  fileDesc("", [file_v1_config, file_v1_restic, file_v1_operations, file_types_value, file_google_protobuf_empty, file_google_api_annotations]);
...
export type SnapshotDiffRequest = Message<"v1.SnapshotDiffRequest"> & {
  ...
  /**
   * @generated from field: string prev_snapshot_id = 4;
   */
...
export type DiffEntry = Message<"v1.DiffEntry"> & {
  ...
  /**
   * @generated from field: string modifier = 3;
   */
  modifier: string;
};
 ...
 *
 * @generated from message v1.DiffStatsDetails
 */
export type DiffStatsDetails = Message<"v1.DiffStatsDetails"> & {
  /**
  ...
  /**
   * @generated from field: int32 dirs = 2;
   */
  dirs: number;

  /**
   * @generated from field: int32 others = 3;
   */
  others: number;

  /**
   * @generated from field: int32 data_blobs = 4;
   */
  dataBlobs: number;

  /**
   * @generated from field: int32 tree_blobs = 5;
   */
  treeBlobs: number;
...
/**
 * Describes the message v1.DiffStatsDetails.
 * Use `create(DiffStatsDetailsSchema)` to create a new message.
 */
export const DiffStatsDetailsSchema: GenMessage<DiffStatsDetails> = /*@__PURE__*/
  messageDesc(file_v1_service, 15);

/**
 * Top-level statistics message
 *
 * @generated from message v1.DiffStatistics
 */
export type DiffStatistics = Message<"v1.DiffStatistics"> & {
  /**
  ...
  /**
   * @generated from field: string target_snapshot = 3;
   */
  targetSnapshot: string;

  /**
   * @generated from field: int32 changed_files = 4;
   */
  changedFiles: number;

  /**
   * @generated from field: v1.DiffStatsDetails added = 5;
   */
  added?: DiffStatsDetails;

  /**
   * @generated from field: v1.DiffStatsDetails removed = 6;
   */
  removed?: DiffStatsDetails;
};

/**
 * Describes the message v1.DiffStatistics.
 * Use `create(DiffStatisticsSchema)` to create a new message.
 */
export const DiffStatisticsSchema: GenMessage<DiffStatistics> = /*@__PURE__*/
...
export type DiffSnapshotResponse = Message<"v1.DiffSnapshotResponse"> & {
  /**
   * @generated from field: v1.DiffStatistics statistics = 1;
   */
  statistics?: DiffStatistics;

  /**
   * @generated from field: repeated v1.DiffEntry entries = 2;
   */
  entries: DiffEntry[];
};
...
export const Backrest: GenService<{
   ...
   *
   * @generated from rpc v1.Backrest.GetSnapshotsDiff
   */
  getSnapshotsDiff: {
    methodKind: "unary";
